...
namespace Windows.UI.Popups
{
    public sealed partial class MessageDialog
    {
        private IUICommand ShowTaskDialog()
        {
            ...
            tdc.pszWindowTitle = string.IsNullOrEmpty(Title) ? " " : Title;
            //tdc.pszMainInstruction = "Main Instruction";
            ...
            {
                var but = new NativeMethods.TASKDIALOG_BUTTON { nButtonID = ibut+1, pszButtonText = this.Commands[ibut].Label };
